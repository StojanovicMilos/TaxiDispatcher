    ...
    public class OverallFunctionalityTests
    {
        ...
        public void OverallFunctionalityTest()
        {
            ...
            string expectedMessages = "Ordering ride from 5 to 0..." + Environment.NewLine +
                                      ...
                                      "Ride accepted, waiting for driver: Nenad"
                                      + Environment.NewLine + "Ordering ride from 0 to 12..."
                                      + Environment.NewLine + "Ride ordered, price: 240" + Environment.NewLine +
                                      "Ride accepted, waiting for driver: Nenad" + Environment.NewLine +
                                      "Ordering ride from 5 to 0..." + Environment.NewLine + "Ride ordered, price: 75" +
                                      Environment.NewLine + "Ride accepted, waiting for driver: Dragan"
                                      + Environment.NewLine + "Ordering ride from 35 to 12..." + Environment.NewLine +
                                      "There are no available taxi vehicles!" + Environment.NewLine
                                      + Environment.NewLine + "Driver with ID = 2 earned today:" + Environment.NewLine +
                                      "Price: 100" + Environment.NewLine + "Price: 240" + Environment.NewLine
